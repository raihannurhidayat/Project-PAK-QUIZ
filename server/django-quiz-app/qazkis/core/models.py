...
class Grade(models.Model):
    ...
    answers_true = models.IntegerField(default=0)
    answers_false = models.IntegerField(default=0)
    student_answer = models.JSONField(blank=True, null=True)
    n_cheating = models.IntegerField(default=0)
    student_grade = models.IntegerField(default=0)
    student_grade_final = models.IntegerField(default=0)
